...
import { compareHands, evaluateOmahaHand, evaluateTexomahaHand, evaluateTexasHand } from "./handEvaluator";
...
export { compareHands, evaluateOmahaHand, evaluateTexomahaHand, evaluateTexasHand };
